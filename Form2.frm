...
Begin VB.Form Form2 
   ...
   Begin VB.CheckBox chkTracer 
      Alignment       =   1  'Right Justify
      Caption         =   "Tracer Program"
      Height          =   195
      Left            =   180
      TabIndex        =   9
      Top             =   2580
...
Dim iMinCols As Integer
    ...
    SaveSetting App.Title, "Settings", "Tracer", chkTracer.Value
...
Dim iMinCols As Integer
    ...
    chkTracer.Value = GetSetting(App.Title, "Settings", "Tracer")
